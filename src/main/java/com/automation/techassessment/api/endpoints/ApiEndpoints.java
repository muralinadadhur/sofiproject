...
import com.automation.techassessment.api.endpoints.movie.MovieGenreEndpoint;
...
public class ApiEndpoints {
    ...
    public MovieGenreEndpoint movieGenre = null;
    ...
    public void buildEndpointInstances() {
        ...
        movieGenre = createService(MovieGenreEndpoint.class);
    }
